...
exports.updateBookingSchema = [
    ...
    body()
        ...
        .custom(value => {
            ...
            const allowUpdates = ['id','code','scode','title','unit','client','project','book_date','sale_price','discount','remarks','name','father_name','residential_address','phone_no','occupation','nationality','cnic','reference_off','nominee_name','relation','email','active','unitdetail','pschedules','transactions','outstanding'];
