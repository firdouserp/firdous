 ...
 check('occupation')
    ...
    body()
        ...
        .custom(value => {
            ...
            const allowUpdates = ['id','name','father_name','postal_address','residential_address','phone_office','phone_residential','phone_mobile','occupation','age','nationality','reference_of','nominee_name','nominee_relation','nominee_address','email','coa'];
            console.log(value);
