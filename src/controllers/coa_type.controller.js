...
class Coa_typeController {
    getAllCoa_type = async (req, res, next) => {
        ...
        // }
        coa_typeList = await Coa_typeModel.find(filter, range, sort,req.projectid);


        let count = await Coa_typeModel.count(filter,req.projectid);
    ...
    createCoa_type = async (req, res, next) => {
        ...
        const result = await Coa_typeModel.create(req.body,req.projectid);
