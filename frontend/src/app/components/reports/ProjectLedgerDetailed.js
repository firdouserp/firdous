...
const CommentGrid = () => {
  ...
  ids.map((id) => {
    ...
    openingbalance =parseFloat(record.coa_obal) + parseFloat(record.cr) - parseFloat(record.dr);
    ...
    <html lang={"en_US"}>
      ...
      <body id="section-to-print">
        <div  className="container-main">
          ...
          <thead>
              <th className="title" colspan="6"> {jwt && jwt.project && jwt.project.title} <br/> {accounttitle} from {filterValues && filterValues.vou_date_from +" to "+filterValues.vou_date_to}</th>
            ...
            {Object.keys(accounts).map((key, index) => {
             ...
             <tr><td colspan="7">
                <table className="periodlist" width="100%">
                        <tr>
                          <td className="subheads"  colspan="6">
                            {coa.accounttitle}
                          </td>
                  ...
                  return (
                    ...
                    <td className="vou_date">{voucher.vou_date}</td>
                  ...
                  <tr>
                          ...
                          <td className="subheads" align='right' >
                            {formatCurrency(coa.total_dr - coa.total_cr)} 
                          </td>
                        </tr>
                        </table>
               </td></tr>
