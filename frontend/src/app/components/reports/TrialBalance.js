...
let grand_total_opening_dr=0;
 ...
 let grand_total_closing_cr=0;
  ...
  for (var index in groupSubHeads) {
    ...
    grand_total_opening_dr +=subhead.total_pl_dr;
    grand_total_opening_cr +=subhead.total_pl_cr;
    grand_total_current_dr+=subhead.total_p_dr;
    grand_total_current_cr+=subhead.total_p_cr;
